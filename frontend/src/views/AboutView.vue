...
<template>
  <div class="page-container-slide page-about">
    ...
    <div class="page-about-github">
      <div class="page-about-github__name">
    ...
    <div class="page-about-footer">
        ...
        <div class="page-about-footer__wrapper">
          <a href="https://aurlemon.top" target="_blank">
            <div class="page-about-footer__user">
              ...
              <div
                class="page-about-footer__name"
                v-tippy="{ content: '别信，船政好不到哪去' }"
              >
                柠檬
              </div>
              <div
                class="page-about-footer__id"
                v-tippy="{ content: 'MC 的 ID 也是这个' }"
              >
                Aurora_Lemon
              </div>
            </div>
      ...
      <div class="page-about-footer__techstacks">
        <div class="page-about-footer__title">
          项目涉及的工具链（写在这=用过，≠会了）
        </div>
        <div
          class="page-about-footer__techstack"
          v-tippy="{ content: '先进👍' }"
        >
        ...
        <div
          class="page-about-footer__techstack"
          v-tippy="{ content: '和 React 比，Vue 写的习惯👍' }"
        >
        ...
        <div
          class="page-about-footer__techstack"
          v-tippy="{ content: '类型检查写多了就习惯了，我们 TS 伟大无需多言' }"
        >
          <a href="https://www.typescriptlang.org/" target="_blank">
            <img
              class="tech-logo"
              src="../assets/images/logo/TypeScript_logo.svg"
            />
            TypeScript
          </a>
        </div>
        ...
        <div
          class="page-about-footer__techstack"
          v-tippy="{
            content: '没有预处理器要写死了，沙比 CSS 写多了看着都头大',
          }"
        >
        ...
        <div
          class="page-about-footer__techstack"
          v-tippy="{ content: '有点难看' }"
        >
          <a href="https://echarts.apache.org/" target="_blank">
            <img
              class="tech-logo"
              src="../assets/images/logo/ECharts_logo.png"
            />
            Apache ECharts
          </a>
        </div>
        <div
          ...
          v-tippy="{
            content:
              '小项目感觉没必要用 UI 库，而且没几个好看的，特别是 Element 丑死了',
          }"
        >
        ...
        <div
          class="page-about-footer__techstack"
          v-tippy="{ content: '俗称 Spring.js' }"
        >
          <a href="https://nestjs.com/" target="_blank">
            <img
              class="tech-logo"
              src="../assets/images/logo/Nestjs_logo.svg"
            />
            Nest.js
          </a>
        </div>
        ...
        <div
          class="page-about-footer__techstack"
          v-tippy="{ content: '第一次用，高级' }"
        >
          <a href="https://typeorm.io/" target="_blank">
            <img
              class="tech-logo"
              src="../assets/images/logo/TypeORM_logo.png"
            />
            TypeORM
          </a>
        </div>
...
.page-about {
  ...
  .page-about-github {
    ...
    border-radius: 12px;
    background:
      radial-gradient(ellipse at 5% 0%, #bf398910 0, transparent 75%),
      radial-gradient(ellipse at 60% 0%, #096bde10 0, transparent 75%);
