...
const updateDone = async () => {
  ...
  if (isDone.value) {
    ...
    await userStore.addProgress(
      currentQuestion.value.pid,
      currentQuestion.value.course,
  ...
  >
    ...
    <div class="question-render-tools">
      ...
      <div class="question-render-tools__buttons">
        <div
          class="question-render-tools__value"
          content="正确率"
          v-tippy="{ appendTo: 'parent' }"
        >
          {{
            questionAccuracy(
              currentQuestion?.done_count ?? 0,
              currentQuestion?.incorrect_count ?? 0,
            ).toFixed(0) + '%'
          }}
        </div>
        <div
        ...
        >
          ...
          <div class="question-tools-info__list">
            <div class="question-tools-info__item">
              <div class="question-tools-info__value">
                {{ currentQuestion?.crawl_count }}
              </div>
              <div class="question-tools-info__label">出现次数</div>
            </div>
            <div class="question-tools-info__item">
              <div class="question-tools-info__value">
                {{ currentQuestion?.done_count }}
              </div>
              <div class="question-tools-info__label">被完成次数</div>
            </div>
            <div class="question-tools-info__item">
              <div class="question-tools-info__value">
                {{ currentQuestion?.incorrect_count }}
              </div>
              <div class="question-tools-info__label">错误计数</div>
            </div>
            <div class="question-tools-info__item">
              <div class="question-tools-info__value">
                {{ formatMileTimestamp(currentQuestion?.created_time ?? '0') }}
              </div>
              <div class="question-tools-info__label">创建时间</div>
            </div>
            <div class="question-tools-info__item">
              <div class="question-tools-info__value">
                {{ formatMileTimestamp(currentQuestion?.updated_time ?? '0') }}
              </div>
              <div class="question-tools-info__label">更新时间</div>
            </div>
            <div class="question-tools-info__item">
              <div class="question-tools-info__value">
                {{ formatMileTimestamp(currentQuestion?.crawl_time ?? '0') }}
              </div>
